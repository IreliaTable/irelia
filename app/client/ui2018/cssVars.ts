...
export const colors = {
  ...
  cursor: new CustomProp('color-cursor', '#0e36d0'),
...
export const vars = {
  ...
  primaryBgHover:   new CustomProp('primary-fg-hover', '#1f41c6'),
  ...
  controlFgHover: new CustomProp('primary-fg-hover', '#1f41c6'),
...
export const theme = {
  ...
  controlBorder: new CustomProp('theme-control-border', undefined, '#0e36d0'),
